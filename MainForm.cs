    ...
    public partial class MainForm : Form
    {
        ...
        private void LoadData()
        {
            categoryItems = new Dictionary<string, List<string>>
            {
                ...
                ["Headset"] = new List<string> { "Earpeice", "Ops-Core AMP Headset", "Peltor Alert", "Peltor ComTac", "Peltor Lite-Com 3", "Revision ComCenter 2 Headset", "Safariland Liberator IV", "Safariland TABC 3", "TCI Liberator II Headset", "TCI Patrol II Headset" }.OrderBy(x => x).ToList(),
